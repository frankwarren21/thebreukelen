        ...
        function OsSlipScreen() {
            $('.fullpage-container').each(function () {
                ...
                if (slipOn === false) {
                    slipOn = true;
                    $this.fullpage({
                        anchors: ['sectionHome', 'sectionAbout', 'sectionDinner', 'sectionBrunch', 'sectionLunch', 'sectionEvents','sectionContact'],
                        navigation: true,
                        navigationTooltips: ['HOME', 'ABOUT', 'DINNER', 'BRUNCH', 'LUNCH', 'EVENTS','CONTACT'],
                        menu: '#slip-menu',
                        scrollOverflow: true
                    });
                }
